...
if [ "$target" = "linux64" ]; then
    filename=./linux64/atomic-sftp
    name="atomic-sftp_linux64"
    ...
    filename=./win64/atomic-sftp.exe
    name="atomic-sftp_win64.exe"
    ...
    filename=./arm7/atomic-sftp
    name="atomic-sftp_arm7"
